...
Usage: 
    pesq, csig, cbak, covl, ssnr, stoi = calculate_mos(cleanFile, enhancedFile, Fs, path)
...
Example call:
    pesq_output, csig_output, cbak_output, covl_output, ssnr_output, stoi_output = \
            calculate_mos(target_audio, output_audio, 16000, 0)
"""


def calculate_mos(cleanFile, enhancedFile, Fs, path=0):
    alpha = 0.95
    ...
    # ESTOI = stoi(data1, data2, sampling_rate1, extended=True)

    return pesq_mos, STOI, CSIG, CBAK, COVL, segSNR
